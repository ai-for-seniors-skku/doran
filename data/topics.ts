...
export const topics: Topic[] = [
  {
    ...
    draft: {
      ...
      aiInstruction:
        "답변은 손주에게 바로 보낼 수 있는 짧은 문자 하나만 작성해줘. 말투는 따뜻하고 다정하게, 지나치게 길지 않게 써줘. 가족이 자연스럽게 전하는 말처럼 써주고, 과하게 형식적인 표현은 피하고, 이모지는 많아도 1개까지만 사용해줘.",
      helpText:
    ...
    rewrite: {
      helpParagraphs: [
        `"AI에게 전할 말"이 "프롬프트 작성"으로 바뀐 걸 보셨나요?`,
        `AI를 쓰면서 AI에게 시키는 말을 "프롬프트"라고 부릅니다.`,
        `이제 직접 프롬프트를 완성해볼까요?`,
        `손주가 아닌 다른 사람에게 메시지를 보내보거나,\n보고싶다거나 연락하라는 말을 넣으며\n프롬프트를 만들어보세요.`,
      ],
    },
  },
  {
...
문장은 너무 길지 않게 쓰고, 과장된 표현은 피하고, 바로 이해할 수 있게 정리해줘.`,
    ...
    rewrite: {
      helpParagraphs: [
        `이제 여행 조건을 직접 적어보는 연습을 해볼까요?`,
        `AI에게 원하는 여행 스타일을 자세히 적을수록\n더 잘 맞는 추천을 받을 수 있어요.`,
        `예를 들면\n"많이 걷지 않아도 되고, 맛집이 많고,\n일정표처럼 정리해줘"\n처럼 적어볼 수 있어요.`,
        `여행지 분위기, 이동 방식, 숙소 조건,\n보고 싶은 풍경 같은 내용을 함께 넣어보세요.`,
      ],
    },
  },
  {
...
부담 없이 따라 할 수 있게 짧고 친절하게 써줘.`,
    ...
    rewrite: {
      helpParagraphs: [
        `이제 원하는 간식 조건을 직접 적어보는 연습을 해볼까요?`,
        `AI에게 재료, 맛, 만드는 방법을\n자세히 적을수록 더 잘 맞는 조리법을 받을 수 있어요.`,
        `예를 들면\n"달걀로 만들고, 불 없이 가능하고,\n10분 안에 끝나는 달콤한 간식으로 알려줘"\n처럼 적어볼 수 있어요.`,
        `재료, 시간, 설거지 양, 아이와 함께 만드는지 같은\n조건도 함께 넣어보세요.`,
      ],
    },
  },
];
